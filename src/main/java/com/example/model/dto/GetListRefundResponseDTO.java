...
public class GetListRefundResponseDTO {
    @Schema(description = "Events on current page")
    List<RefundResponseDTO> content;

    @Schema(description = "Pageable request details")
    GetListRefundResponseDTO.PageableDetail pageable;
    ...
    GetListRefundResponseDTO.SortDetail sort;
