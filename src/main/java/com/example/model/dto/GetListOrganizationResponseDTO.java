...
public class GetListOrganizationResponseDTO {
    @Schema(description = "Organizations on current page")
    List<CreateOrganizationResponseDTO> content;
    ...
    @Schema(description = "Total organizations", example = "142")
    long totalElements;
