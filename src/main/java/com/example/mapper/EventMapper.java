...
public interface EventMapper {
    ...
    default CreateEventResponseDTO toCreateResponseDTO(Events entity) {
        ...
        dto.setTypeZhCn(entity.getTypeZhCn());
        dto.setTypeZhHk(entity.getTypeZhHk());
        dto.setCategory(entity.getCategory());
        dto.setCategoryZhCn(entity.getCategoryZhCn());
        dto.setCategoryZhHk(entity.getCategoryZhHk());
        dto.setDescription(entity.getDescription());
        dto.setDescriptionZhCn(entity.getDescriptionZhCn());
        dto.setDescriptionZhHk(entity.getDescriptionZhHk());
        dto.setLocation(entity.getLocation());
        dto.setLocationZhCn(entity.getLocationZhCn());
        dto.setLocationZhHk(entity.getLocationZhHk());
        dto.setDuration(entity.getDuration());
        dto.setBadge(entity.getBadge());
        dto.setBadgeZhCn(entity.getBadgeZhCn());
        dto.setBadgeZhHk(entity.getBadgeZhHk());
        ...
        dto.setEquipmentZhCn(entity.getEquipmentZhCn());
        dto.setEquipmentZhHk(entity.getEquipmentZhHk());
        ...
        dto.setAdditionalInfoZhCn(entity.getAdditionalInfoZhCn());
        dto.setAdditionalInfoZhHk(entity.getAdditionalInfoZhHk());
        dto.setCancellationPolicy(entity.getCancellationPolicy());
        dto.setCancellationPolicyZhCn(entity.getCancellationPolicyZhCn());
        dto.setCancellationPolicyZhHk(entity.getCancellationPolicyZhHk());
        dto.setCustomQuestion(entity.getCustomQuestion());
        dto.setCustomQuestionZhCn(entity.getCustomQuestionZhCn());
    ...
    @Mapping(target = "eventPicKeys", ignore = true)
    @Mapping(target = "eventPicUrls", ignore = true)
