...
public class BookingsByActivityDateExcelBuilder {
  ...
  public byte[] build(
    ...
    try (Workbook workbook = new XSSFWorkbook();
      ...
      writeActivityHeaderRow(sheet, rowIndex++, headers);
      ...
      writeActivityTotalRow(sheet, rowIndex++, headers.length, ticketTypeNames, totals);
  ...
  private int writeMetadata(
      ...
      int columnCount) {
    int row = 2;
    createLabelValueRow(sheet, row++, "ALL INTERNET BOOKINGS BY ACTIVITY DATE", null, columnCount);
    row++;
  ...
  private void writeActivityHeaderRow(Sheet sheet, int rowIndex, String[] headers) {
    Row row = sheet.createRow(rowIndex);
  ...
  private void writeActivityTotalRow(
      Sheet sheet,
      int rowIndex,
      int columnCount,
      List<String> ticketTypeNames,
      ActivityTotals totals) {
    int passengerStartColumn = 13;
